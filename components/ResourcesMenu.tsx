...
export default function ResourcesMenu({ className = '' }: { className?: string }) {
  return (
    <details className={`group relative ${className}`}>
      ...
      <div className="absolute right-0 top-full z-50 mt-3 w-56 rounded-2xl border border-[#EBE6F4] bg-white p-2 shadow-xl sm:left-1/2 sm:right-auto sm:-translate-x-1/2">
