...
console.log(`Migration contract verified: ${files.length} active versions, unique and ordered; hosted manifest ${manifest.length} exact steps; batching manifest ${batchingManifest.length} exact steps`)
