export const researchFields={
  ...
  marketingHooks:Array.from({length:5},(_,i)=>({hook:`Hook ${i+1}`,readerAppeal:'Specific reader appeal',promotionalLine:'Une promesse romantasy sombre.'})),
  socialContentIdeas:Array.from({length:8},(_,i)=>({concept:`Concept ${i+1}`,explanation:'Book-specific concept',caption:'Une légende française.',hashtags:['#BookTokFrance','#Romantasy'],format:'Reel'})),
